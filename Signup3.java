...
{  
  ...
  Signup3(String formno) {
    ...
    r1.setBackground(new Color(204, 215, 215));
    r1.setBounds(100, 180, 150, 30);
    add(r1);
    
    r2 = new JRadioButton("Fixed Deposit Account");
    r2.setFont(new Font("Raleway", 1, 16));
    r2.setBackground(new Color(204, 215, 215));
    r2.setBounds(350, 180, 300, 30);
    add(r2);
    
    r3 = new JRadioButton("Current Account");
    r3.setFont(new Font("Raleway", 1, 16));
    r3.setBackground(new Color(204, 215, 215));
    r3.setBounds(100, 220, 250, 30);
    add(r3);
    
    r4 = new JRadioButton("Recurring Deposit Account");
    r4.setFont(new Font("Raleway", 1, 16));
    r4.setBackground(new Color(204, 215, 215));
    ...
    setLayout(null);
    getContentPane().setBackground(new Color(204, 215, 215));
    setSize(850, 850);
    setVisible(true);
    ...
    try
    {
      if (ae.getSource() == b1)
      {
        if (atype.equals("")) {
          ...
          String q1 = "insert into signup3 values('"+formno+"','" + atype + "','"+Accountno+"','"+pin+"','" +facility+"')";
